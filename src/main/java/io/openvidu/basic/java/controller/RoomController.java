...
//														  @RequestBody(required = false) Map<String, Object> params, @RequestBody(required = false) String password)
//			throws Exception {
//		log.info("enterRoom : {}",params);
//		Session session = roomService.getActiveSession(sessionId);
//		if (session == null) {
...
//		Connection connection = session.createConnection(properties);
//
//		RoomEnterDto roomEnterDto = new RoomEnterDto(sessionId,password);
//
